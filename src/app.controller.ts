...
import { ResponseOfVerifyAndCreateUser } from './DTO/ResponseOfVerifyAndCreateUser';
...
export class AppController {
  ...
  private async createWithNotExist(name: string, email: string) {
    ...
    //http://localhost:3000/user/verify-and-create-user?email=jidi@email.com&name=Jinei
